...
| 场景 | 代码 | 数据特征 |
|------|------|----------|
| 正常运营 | `normal` | 业务平稳发展，小幅增长 |
| 促销活动 | `promotion` | 各项指标大幅上升 |
| 业务淡季 | `off_season` | 市场需求疲软，数据下降 |
| 异常事件 | `anomaly` | 突发情况导致数据异常 |
| 自定义场景 | `custom` | 用户描述场景，AI生成数据 |
